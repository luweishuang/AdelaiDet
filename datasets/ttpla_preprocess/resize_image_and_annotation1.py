...
# jsndata1 = json.load(open("../coco/annotations/instances_val2017.json",'r'))
# jsndata2 = json.load(open("../ttpla/annotations/test.json",'r'))
# exit()
output_folder = '.data'
...
ap.add_argument('-t', '--path_imgs_annotation', default="data/ttpla_srcdata/", help = 'path to imgs with annotations')
args = ap.parse_args()
